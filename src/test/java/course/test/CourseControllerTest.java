...
public class CourseControllerTest {
	...
	public void testAddProcess() throws Exception{
		...
		.andExpect(status().isOk()).andExpect(view().name("result")).andDo(print());
	}
	
	@Test
	public void testAllCourse() throws Exception {
		this.mockMvc.perform(get("/course/all")).andDo(print()).andExpect(status().isOk())
